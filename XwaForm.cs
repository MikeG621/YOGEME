...
namespace Idmr.Yogeme
{
    ...
    public partial class XwaForm : Form
    {
        ...
        CheckBox[] chkOpt = new CheckBox[18];  //[JB] Added Ion Pulse
        // Mess
        ...
        void numOVar1_ValueChanged(object sender, EventArgs e)
        {
            ...
            switch (command)
            {
                ...
                case 0x24: case 0x2D: case 0x3A: case 0x39: case 0x3D: //Self-Destruct, Repair Self, Board to Defuse, Park At, Work On
