...
/* CHANGELOG
 * v1.1, 120715
 * - XWA custom backdrops loaded for preview
 * v1.0, 110921
 * - Release
 */
using System;
...
namespace Idmr.Yogeme
{
	...
	public partial class dlgBackdrop : Form
	{
		...
		public dlgBackdrop(MissionFile.Platform platform, int index)
		{
			_platform = platform;
		...
		public dlgBackdrop(int index, int shadow)
		{
