...
namespace Idmr.Yogeme
{
	partial class XwaForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblPMFDelay.Visible = false;
			// 
			// cboPMFEomFG
			// 
			...
			this.numPMFEomDelay.Visible = false;
			...
			this.lblOMCDelay.Visible = false;
			// 
			// label115
			// 
			...
			this.numOMCEomDelay.Visible = false;
			...
			this.lblPMCDelay.Visible = false;
			// 
			// label114
			// 
			...
			this.numPMCEomDelay.Visible = false;
