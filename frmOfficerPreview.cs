...
namespace Idmr.Yogeme
{
	...
	public partial class frmOfficerPreview : Form
	{
		string[] _answerLines;
		int _page = 1;
		...
		public frmOfficerPreview(Questions questions)
		{
			try
			{
			...
			((LfdReader.Font)_empire.Resources["FONTfont8"]).SetColor(_normalText);;
			#endregion
